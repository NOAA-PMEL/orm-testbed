...
class PersonRef(Base):
    ...
    object_id: Mapped[PG_UUID] = mapped_column(PG_UUID, ForeignKey("person_instance.id"), default=None)
...
class OrganizationRef(Base):
    ...
    description: Mapped[Optional[String]] = mapped_column(String, default=None)
    role: Mapped[Optional[String]] = mapped_column(String, default=None)
    object_id: Mapped[PG_UUID] = mapped_column(PG_UUID, ForeignKey("organization_instance.id"), default=None)
...
class OrganizationInstance(Base):
