...
with Session(constants.postgres_engine) as session:
    ...
    user = DashboardUser(email='roland.schweitzer@noaa.gov', active=True)
    sally = Person(
        first_name="Sally",
        last_name="Scientist",
        organizations=[
            Organization(
                organization_identifier="https://ror.org/05rfqv493",
    ...
    jane = Person(
        ...
        organizations=[
            Organization(
                organization_identifier="https://ror.org/01s7b5y08",
                organization_identifier_type="ror",
    ...
    joyce = Person(
        ...
        organizations=[
            Organization(
                organization_identifier="https://ror.org/02s1t7068",
                organization_identifier_type="ror",
    ...
    bill = Person(first_name="Bill",
            ...
            organizations=[
                ...
                Organization(
                    organization_identifier="https://ror.org/03xrrjk67",
                    organization_identifier_type="ror",
    ...
    user.people = [sally, joyce, jane, bill]
