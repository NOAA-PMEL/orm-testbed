...
with Session(constants.postgres_engine) as session:
    ...
    user = DashboardUser(email='joe.science@noaa.gov')
    submission = Submission(
                files=[
                ...
                oads_metadata=OadsMetadata(
                    ...
                    investigators=[
                        ...
                        Person(
                            ...
                            organizations=[
                                Organization(
                                    ror_id="https://ror.org/05p1j8758",
                    ...
                    data_submitter=[
                            Person(first_name="Ellie",
                                last_name="O'Donnel",
                                dashboard_user = user,
                                organizations=[
                                    Organization(ror_id="https://ror.org/03xrrjk67", name="University of Alabama"),
